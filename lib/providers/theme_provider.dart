...
class ThemeProvider extends ChangeNotifier {
  ...
  static final ThemeData _darkTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.dark(
      ...
      surfaceContainerHighest: Color(0xFF242930),
      onPrimary: Color(0xFFFFFFFF),
      onSecondary: Color(0xFF94A3B8),
      onSurface: Color(0xFFE2E8F0),
      outline: Color(0xFF334155),
      outlineVariant: Color(0xFF242930),
    ),
    cardColor: const Color(0xFF1A1F26),
    dividerColor: const Color(0xFF242930),
    ...
    cardTheme: CardThemeData(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: const BorderSide(color: Color(0xFF242930), width: 1),
      ),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
