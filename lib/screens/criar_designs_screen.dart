...
class CriarDesignsPage extends StatefulWidget {
  const CriarDesignsPage({super.key});
  @override
  State<CriarDesignsPage> createState() => _CriarDesignsPageState();
}

class _CriarDesignsPageState extends State<CriarDesignsPage> {
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        PopupMenuItem<String>(
          value: 'novo',
          child: Row(children: [
            Icon(Icons.add_rounded, color: isDark ? AppColors.darkTextPrimary : AppColors.textPrimary, size: 20),
            const SizedBox(width: 12),
            Text('Novo design', style: TextStyle(color: isDark ? AppColors.darkTextPrimary : AppColors.textPrimary, fontSize: 15)),
          ]),
        ),
        ])],
      ),
