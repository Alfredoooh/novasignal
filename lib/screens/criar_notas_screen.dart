...
class CriarNotasPage extends StatefulWidget {
  const CriarNotasPage({super.key});
  @override
  State<CriarNotasPage> createState() => _CriarNotasPageState();
}

class _CriarNotasPageState extends State<CriarNotasPage> {
  @override
      ...
      appBar: AppBar(
        ...
        PopupMenuItem<String>(
          ...
          child: Row(children: [
            ...
            Text('Nova nota', style: TextStyle(color: isDark ? AppColors.darkTextPrimary : AppColors.textPrimary, fontSize: 15)),
          ]),
        ),
        ])],
      ),
