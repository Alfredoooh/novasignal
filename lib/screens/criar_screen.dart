...
class _CriarScreenState extends State<CriarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Cores dos ícones — no dark, mais sólidas (sem opacidade)
                ...
                _TypeCard(
                  ...
                  onTap: () async {
                    await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (_) =>
                            const EditorScreen(docType: DocType.document),
                      ),
                    );
...
class _TypeCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // No dark mode: cor de fundo do card mais sólida; ícone sólido
    final cardBg = isDark
        ? Color.lerp(const Color(0xFF1C1C1E), iconColor, 0.08)!
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(child: _svg(svg, iconClr, s: 22)),
                ),
                const Spacer(),
                // Título
                Text(
...
// ── Card de importação (faixa larga) ──────────────────────────────────────
