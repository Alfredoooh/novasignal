...
class _NativeEditorViewState extends State<_NativeEditorView> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final appBarBg = isDark ? const Color(0xFF0D0D0D) : const Color(0xFFFFFFFF);

    return Column(children: [
      // ── AppBar nativo — idêntico ao Chat ─────────────
      Container(
        color: appBarBg,
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          IconButton(
            icon: SvgPicture.string(
              '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9.878,18.122a3,3,0,0,0,4.244,0l3.211-3.211A1,1,0,0,0,15.919,13.5l-2.926,2.927L13,1a1,1,0,0,0-1-1h0a1,1,0,0,0-1,1l-.009,15.408L8.081,13.5a1,1,0,0,0-1.414,1.415Z"/><path d="M23,16h0a1,1,0,0,0-1,1v4a1,1,0,0,1-1,1H3a1,1,0,0,1-1-1V17a1,1,0,0,0-1-1H1a1,1,0,0,0-1,1v4a3,3,0,0,0,3,3H21a3,3,0,0,0,3-3V17A1,1,0,0,0,23,16Z"/></svg>',
              width: 20, height: 20,
              colorFilter: ColorFilter.mode(textP, BlendMode.srcIn)),
            onPressed: () => _wvc?.evaluateJavascript(
              source: 'if(typeof window.saveDocument==="function") window.saveDocument();'),
          ),
          IconButton(
            icon: SvgPicture.string(
              '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m12,0C5.383,0,0,5.383,0,12s5.383,12,12,12,12-5.383,12-12S18.617,0,12,0Zm0,22c-5.514,0-10-4.486-10-10S6.486,2,12,2s10,4.486,10,10-4.486,10-10,10Zm-4-10c0,.828-.672,1.5-1.5,1.5s-1.5-.672-1.5-1.5.672-1.5,1.5-1.5,1.5.672,1.5,1.5Zm11,0c0,.828-.672,1.5-1.5,1.5s-1.5-.672-1.5-1.5.672-1.5,1.5-1.5,1.5.672,1.5,1.5Zm-5.5,0c0,.828-.672,1.5-1.5,1.5s-1.5-.672-1.5-1.5.672-1.5,1.5-1.5,1.5.672,1.5,1.5Z"/></svg>',
              width: 20, height: 20,
