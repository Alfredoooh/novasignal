...
class LimparImagemPage extends StatefulWidget {
  const LimparImagemPage({super.key});
  @override
  State<LimparImagemPage> createState() => _LimparImagemPageState();
}

class _LimparImagemPageState extends State<LimparImagemPage> {
  @override
